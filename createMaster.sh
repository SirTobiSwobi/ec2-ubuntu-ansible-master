...
scp -i $1 ./ansible.cfg ubuntu@$2:/home/ubuntu/ec2-ubuntu-ansible-master
...
ssh -i $1 ubuntu@$2 sudo cp /home/ubuntu/ec2-ubuntu-ansible-master/ansible.cfg /etc/ansible
